...
export function Sidebar() {
  ...
  return (
    <div className="flex flex-col w-72 bg-surface-950 border-r border-surface-800/50 text-surface-300">
      <div className="flex h-20 shrink-0 items-center px-8">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-medium text-surface-500 uppercase tracking-[0.2em] mt-1">Admin Panel</span>
          </div>
        </div>
      </div>
